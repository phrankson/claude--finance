# Junior Advisor Instruction Manual — Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Write a complete, standalone instruction manual for a junior financial advisor (no prior Claude Code experience) explaining how to use the AI Personal Finance Advisor skill system with German clients.

**Architecture:** Single comprehensive Markdown guide saved at `docs/DE-BERATER-GUIDE.md`. Organized as a handbook — setup first, then client workflows, then skill-by-skill reference with copy-paste prompts, then scenarios, then limitations. Written in English with German terms inline where client-facing.

**Tech Stack:** Markdown, Claude Code skill system (`/finance` commands), project's SKILL.md files as source of truth.
...
|------|--------|----------------|
| `docs/DE-BERATER-GUIDE.md` | CREATE | The complete instruction manual |
| `docs/superpowers/plans/2026-06-13-junior-advisor-guide.md` | This file | Implementation plan |

---

## Task 1: Create File Skeleton + Section Headers

**Files:**
- Create: `docs/DE-BERATER-GUIDE.md`

- [ ] **Step 1: Create the file with all top-level section headers**

```bash
cat > /path/to/project/docs/DE-BERATER-GUIDE.md << 'EOF'
...
```bash
ls -la docs/DE-BERATER-GUIDE.md
```
...
```bash
git add docs/DE-BERATER-GUIDE.md
git commit -m "docs: add junior advisor guide skeleton"
```

---

## Task 2: Write Section 1 — What This System Does

**Files:**
- Modify: `docs/DE-BERATER-GUIDE.md`

- [ ] **Step 1: Append Section 1 content to the file**

Write the following content into Section 1 of `docs/DE-BERATER-GUIDE.md`:
...
|-------|-----------------|-------------|
| `/finance analyze` | Complete financial health (5 areas) | FINANCE-ANALYSIS.md |
...
```bash
grep -c "What it produces\|What it does NOT\|Who should use" docs/DE-BERATER-GUIDE.md
```
Expected output: `3`
...
```bash
git add docs/DE-BERATER-GUIDE.md
git commit -m "docs: add section 1 — what system does"
```

---

## Task 3: Write Section 2 — Setup Checklist
...
Write the following into Section 2 of `docs/DE-BERATER-GUIDE.md`:
...
```bash
grep -c "Prerequisites\|Client Workspace\|Verify Installation" docs/DE-BERATER-GUIDE.md
```
Expected: `3`
...
```bash
git add docs/DE-BERATER-GUIDE.md
git commit -m "docs: add section 2 — setup checklist"
```

---

## Task 4: Write Section 3 — Client Intake Data Collection
...
This section is critical — it tells the junior advisor exactly what information to gather from a German client before running any skill. Include a printable intake form concept.

Write the following into Section 3 of `docs/DE-BERATER-GUIDE.md`:
...
```bash
grep -c "Block A\|Block B\|Block C\|Block D\|Block E\|Block F\|Block G" docs/DE-BERATER-GUIDE.md
```
Expected: `7`
...
```bash
git add docs/DE-BERATER-GUIDE.md
git commit -m "docs: add section 3 — client intake data collection"
```

---

## Task 5: Write Section 4 — Core Workflow for New Client
...
This section is the most important for daily use. It describes the recommended sequence for a new client engagement.

Write the following into Section 4 of `docs/DE-BERATER-GUIDE.md`:
...
```bash
grep -c "Step 1:\|Step 2:\|Step 3:\|Step 4:\|Step 5:" docs/DE-BERATER-GUIDE.md
```
Expected: `10` (5 in the sequence + 5 in the section headers)

- [ ] **Step 3: Commit**

```bash
git add docs/DE-BERATER-GUIDE.md
git commit -m "docs: add section 4 — core workflow for new client"
```

---

## Task 6: Write Section 5 — Skill Reference with Prompts
...
This section gives copy-paste prompts and tips for each skill. It's the daily reference card.

Write the following into Section 5 of `docs/DE-BERATER-GUIDE.md`:
...
Kindersausbildung (note: no 529 equivalent in Germany):
```
...
- [ ] **Step 2: Verify all skill sections present**

```bash
grep -c "^### \`/finance" docs/DE-BERATER-GUIDE.md
```
Expected: `14` (one per skill)

- [ ] **Step 3: Commit**

```bash
git add docs/DE-BERATER-GUIDE.md
git commit -m "docs: add section 5 — skill reference with prompts"
```

---

## Task 7: Write Section 6 — Common Client Scenarios
...
Write the following into Section 6 of `docs/DE-BERATER-GUIDE.md`:
...
- [ ] **Step 2: Verify scenarios present**

```bash
grep -c "^### Scenario" docs/DE-BERATER-GUIDE.md
```
Expected: `6`
...
```bash
git add docs/DE-BERATER-GUIDE.md
git commit -m "docs: add section 6 — common client scenarios"
```

---

## Task 8: Write Sections 7, 8, 9 — Output Reading, Limitations, Quick Reference

**Files:**
- Modify: `docs/DE-BERATER-GUIDE.md`

- [ ] **Step 1: Add Section 7 — Reading the Output Files**

Write the following into Section 7 of `docs/DE-BERATER-GUIDE.md`:
...
**Social Security / GRV section** — shows claiming age recommendation
...
- [ ] **Step 2: Add Section 8 — Limitations and Escalation Rules**

Write the following into Section 8 of `docs/DE-BERATER-GUIDE.md`:
...
- [ ] **Step 3: Add Section 9 — Quick Reference Card**

Write the following into Section 9 of `docs/DE-BERATER-GUIDE.md`:
...
```bash
grep -n "^## [0-9]" docs/DE-BERATER-GUIDE.md
```
Expected:
```
## 1. What This System Does
...
- [ ] **Step 5: Check total line count (should be substantial)**

```bash
wc -l docs/DE-BERATER-GUIDE.md
```
Expected: >400 lines
...
```bash
git add docs/DE-BERATER-GUIDE.md
git commit -m "docs: complete junior advisor guide — sections 7, 8, 9"
```
...
- [ ] Section 1 covers all 15 skills in the command table
- [ ] Section 2 setup steps are executable (no placeholders like "install as directed")
- [ ] Section 3 intake form covers all 7 blocks referenced in skills
- [ ] Section 4 workflow references correct skill trigger commands
- [ ] Section 5 has a prompt for every skill
- [ ] Section 6 has ≥5 realistic German client scenarios with actual prompts
- [ ] Section 7 explains how to read each major output file
- [ ] Section 8 lists clear escalation rules with specific thresholds
- [ ] Section 9 quick reference card has current 2025 figures with annual update reminder
- [ ] No US-specific references remain (no 401k, IRA, Social Security, HSA, etc.)
- [ ] All prompts are copy-paste ready (no "enter your data here" type placeholders)
- [ ] Disclaimer language present and accurate for German legal context

---

## Plan complete and saved to `docs/superpowers/plans/2026-06-13-junior-advisor-guide.md`.
